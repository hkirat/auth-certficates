      ...
      <section className="flex_center page_main flex-col text-center h-full">
        ...
        <div className="mt-14 ">
          <form
            ...
            className="flex flex-col gap-4 items-center mt-12 xl:w-[40vw] md:w-[80vw] w-[90vw]"
          >
            <input
              type="text"
              placeholder="Enter Centificate Number"
              className="input_1"
              {...register('certificateNumber')}
            />
            <NormalButton
              loading={loadingCertificate}
              disabled={!isValid || loadingCertificate}
              className={`btn_primary_${isValid ? '1' : '2'}`}
              type="submit"
            >
              Verify
            </NormalButton>
        ...
        {certificateDetails && (
          <div className="mt-12">
            <div className="">
              <p className="text_sub_heading_size">
                Recipient Name:
                <span className="text_highlight_gradient  font-bold">
                  {' '}
              ...
              <p className="text_sub_heading_size">
                Recipient Email::{' '}
                <span className="text_highlight_gradient  font-bold">
                  {certificateDetails?.recipientEmail}
                </span>
              </p>
              <p className="text_sub_heading_size">
                Date of Issuance:{' '}
                <span className="text_highlight_gradient  font-bold">
                  {formatDateTime(certificateDetails?.createdAt)}{' '}
                </span>
              </p>
            </div>
            <div className="mt-4">
              <Link
                href={'/certificate/' + certificateDetails.certificateNumber}
                target="_blank"
              >
