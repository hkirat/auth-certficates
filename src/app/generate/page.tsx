      ...
      <section className="flex_center page_main flex-col text-center h-full">
        ...
        {createdCertificate && (
          <>
            <div className="mt-12">
              <p>
                Your Certificate Number: {createdCertificate?.certificateNumber}
              </p>
              <a
            ...
            <div className="mt-8">
              <h1 className="text_highlight_gradient text_sub_heading_size mb-2">
                Share Certificate
              </h1>
              <ShareCertificateButtons
                certificateDetails={createdCertificate}
              />
            </div>
          </>
        )}
